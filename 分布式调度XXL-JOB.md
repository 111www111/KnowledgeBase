...
**![image-20221028153927837](images\image-20221028153927837.png)**
...
![image-20221028162443072](images\image-20221028162443072.png)
...
**![image-20221101100952650](images\image-20221101100952650.png)**

新增后界面如下:

**![image-20221101101555269](images\image-20221101101555269.png)**

接着启动定时调度任务

**![image-20221101101737502](images\image-20221101101737502.png)**

#### 2.5.2 查看日志

在调度中心的调度日志中就可以看到，任务的执行结果.

![image-20221101101850629](images\image-20221101101850629.png)

管控台也可以看到任务的执行信息.

**![image-20221101101958510](images\image-20221101101958510.png)**
...
**![image-20221101145048598](images\image-20221101145048598.png)**
...
![image-20221101150421458](images\image-20221101150421458.png)

重新启动,我们可以看到效果是,定时任务会在这两台机器中进行轮询的执行

- 8090端口的控制台日志如下:

  **![image-20221101150852090](images\image-20221101150852090.png)**

- 8091端口的控制台日志如下:

  **![image-20221101150938313](images\image-20221101150938313.png)**
